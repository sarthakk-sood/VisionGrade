                  ...
                  <AnimatePresence>
                    {stagedFiles.length > 0 && (
                      ...
                      >
                        ...
                        {stagedFiles.map((f) => (
                          <div key={f.name} className="flex items-center justify-between rounded-xl border border-white/[0.07] bg-white/[0.03] px-4 py-2.5">
                            <div className="flex items-center gap-2 min-w-0">
                              <FileText className="h-4 w-4 shrink-0 text-blue-400" />
                              <span className="truncate text-xs text-white">{f.name}</span>
                            ...
                            <button
                              ...
                              className="ml-2 rounded-lg p-1 text-slate-600 hover:bg-rose-500/15 hover:text-rose-300"
                            >
                ...
                <AnimatePresence>
                  {(uploadError || topicsError) && (
                    ...
                    >
                      ...
                      <p className="text-xs text-rose-300">{uploadError || topicsError}</p>
                    </motion.div>
                  )}
                </AnimatePresence>
