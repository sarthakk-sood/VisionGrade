...
export default function EvaluationSummary({ average = 0, strengths = [], weaknesses = [] }) {
  return (
    <Card>
      <p className="text-xs uppercase tracking-[0.3em] text-blue-600">Evaluation Summary</p>
      <h3 className="mt-2 text-xl font-bold text-slate-900">Marks and feedback</h3>
